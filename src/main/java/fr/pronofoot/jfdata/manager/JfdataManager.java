package fr.pronofoot.jfdata.manager;
...
import fr.pronofoot.jfdata.config.ConfigTest;
import fr.pronofoot.jfdata.util.UtilJson;
...
public class JfdataManager{
	 ...
	 */
	public JfdataManager() {
		super();
		this.TOKEN = ConfigTest.TOKEN;
	}
